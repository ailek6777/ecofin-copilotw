...
// ---- Languages & currencies (MVP: most common ones for a KZ-based product) ----
const LANGUAGES = [
  { code: "ru", label: "Рус" },
  { code: "kz", label: "Қаз" },
  { code: "en", label: "Eng" },
...
// Rough placeholder FX rates, KZT per 1 unit of currency (MVP demo only)
const CURRENCIES = [
...
const STRINGS = {
  ru: {
    ...
    aiSystemHint:
      "Ты — ассистент EcoFin по ресурсосбережению в Казахстане. Отвечай кратко, дружелюбно, на русском, с конкретными практичными советами.",
    recs: {
      elec_over: [
  ...
  kz: {
    ...
    aiSystemHint:
      "Сен — Қазақстандағы ресурстарды үнемдеу бойынша EcoFin көмекшісісің. Қысқа, достық үнмен, қазақ тілінде, нақты пайдалы кеңестермен жауап бер.",
    recs: {
      elec_over: [
  ...
  en: {
    ...
    aiSystemHint:
      "You are the EcoFin resource-saving assistant for Kazakhstan. Reply briefly and warmly, in English, with specific practical advice.",
    recs: {
      elec_over: [
  ...
  tr: {
    ...
    aiSystemHint:
      "Sen Kazakistan'da kaynak tasarrufu konusunda EcoFin asistanısın. Kısa, samimi ve Türkçe, somut pratik tavsiyelerle yanıt ver.",
    recs: {
      elec_over: [
  ...
  zh: {
    ...
    aiSystemHint:
      "你是哈萨克斯坦的 EcoFin 节约资源助手。请用中文简洁友好地回答，并给出具体实用的建议。",
    recs: {
      elec_over: [
  ...
  uz: {
    ...
    aiSystemHint:
      "Siz Qozog'istonda resurslarni tejash bo'yicha EcoFin yordamchisisiz. Qisqa, do'stona, o'zbek tilida, aniq amaliy maslahatlar bilan javob bering.",
    recs: {
      elec_over: [
    ...
    <div className="min-h-screen w-full" style={{ background: "#FFFDF7", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="border-b border-[#EFE9DA] px-6 py-4 flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Language & currency — separated by a divider */}
          <div className="flex items-center gap-2">
